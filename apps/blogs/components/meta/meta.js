...
export default function Meta(props) {
  ...
  const keywords = articlesTags || tag_keywords || set_keywords || "notícias esportivas, futebol, mma, tênis, hóquei, apostas esportivas, apostas, brasil, premier league, brasileiroo series a"
  // social account
